...
print(get_words(num_words(0)))
print(get_words(num_words(1)))
print(get_words(num_words(10)))
print(get_words(num_words(12)))
print(get_words(num_words(110)))
print(get_words(num_words(111)))
print(get_words(num_words(211)))
print(get_words(num_words(123)))
print(get_words(num_words(1100)))
print(get_words(num_words(1234)))
print(get_words(num_words(12345)))
print(get_words(num_words(100000)))
print(get_words(num_words(100100)))
print(get_words(num_words(123456)))
print(get_words(num_words(567000)))
print(get_words(num_words(1234567)))
print(get_words(num_words(12345678)))
print(get_words(num_words(123456789)))
print(get_words(num_words(1234567891)))
